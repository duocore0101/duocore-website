...
export default function StaffLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    const result = await loginStaff(mobile, password);
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 relative overflow-hidden p-4">
      ...
      <div className="w-full max-w-md relative z-10 mt-8">
        ...
        <div className="text-center mb-6 flex flex-col items-center">
          ...
          <p className="text-slate-500 mt-1 text-sm font-bold italic tracking-wide">Duocore Softwares LLP. Staff Panel</p>
        </div>
          ...
          <CardContent className="p-8 pt-0">
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div className="space-y-2">
                <Label htmlFor="mobile" className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 ml-1">Mobile Number</Label>
              ...
              <div className="flex flex-col gap-3 pt-2">
                ...
                <Link href="/staff/register" className="w-full">
                  <Button type="button" variant="outline" className="w-full h-14 border-white/10 bg-white/[0.02] text-white hover:bg-white/10 hover:text-white font-black rounded-2xl transition-all">
